...
#ifndef LV_ATTRIBUTE_IMG_SYNC
#define LV_ATTRIBUTE_IMG_SYNC
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_SYNC uint8_t sync_map[] = {
...
const lv_image_dsc_t syncSymbol = {
