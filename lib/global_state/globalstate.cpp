...
void GlobalState::setOtaContextLine(const char* line) {
  copyOtaText(m_otaContextLine, (int)sizeof(m_otaContextLine), line);
}
const char* GlobalState::getOtaContextLine() { return m_otaContextLine; }
